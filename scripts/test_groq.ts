...
import { generateItineraries } from '../src/lib/groq/itineraryService';
...
async function test() {
  console.log('Testing Groq generation with tsx...');
  try {
    const res = await generateItineraries(mockDraftPlans as any, mockContext);
